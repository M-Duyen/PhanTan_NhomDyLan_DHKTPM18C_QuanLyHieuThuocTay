...
//    }
    ...
    private void searchVendor() {
        ...
        if (countryCriteria != null) {
            ArrayList<Vendor> searchResults = vendor_dao.getVendorListByCountry(countryCriteria);
            ...
            ArrayList<Vendor> searchResults = vendor_dao.getVendorListByCriterias(nameCriteria_txt);
            if (searchResults.isEmpty()) {
