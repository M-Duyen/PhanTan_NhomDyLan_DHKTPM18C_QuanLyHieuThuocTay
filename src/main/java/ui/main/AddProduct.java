...
//        testData(tableProduct);
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (flag == false) {
            ...
            new Product_DAO().addManyProduct(temp);
            temp = new ArrayList<>();
            setDataTable(tableProduct, temp);
...
//            System.out.println("unitNote: " + product.getUnitNote());
    ...
    public void showDataComboBoxVendor() {
        ...
        java.util.List<Vendor> list = vendor_dao.getVendorList();

        Set<Vendor> uniqueValues = new LinkedHashSet<>(list);
        java.util.List<Vendor> uniqueList = new ArrayList<>(uniqueValues);
    ...
    public void showDataComboBoxCategory() {
        ...
        java.util.List<Category> list = category_dao.getCategoryList();
