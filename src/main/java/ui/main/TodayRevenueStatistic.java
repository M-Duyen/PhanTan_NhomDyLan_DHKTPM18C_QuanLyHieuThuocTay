...
public class TodayRevenueStatistic extends javax.swing.JPanel {
    ...
    public TodayRevenueStatistic() {
        ...
        if(!Login.checkRole()){
            ...
            if(employee != null){
                ...
                ArrayList<Order> orderList = new Order_DAO().filterOrderByEmpID(role);
                ...
                lblSum_number.setText(StaticProcess.df.format(new Order_DAO().calculateTotalAllOrder(role)));
                repaint();
            }

            Employee employ = new Employee_DAO().getEmployee_ByID(role);
            if(employ != null){
    ...
    private void initComponents() {
        ...
        tableStatictis = new javax.swing.JTable();
        ...
        tableStatictis.setModel(new javax.swing.table.DefaultTableModel(
                new Object [][] {
    ...
    private javax.swing.JTable tableStatictis;
