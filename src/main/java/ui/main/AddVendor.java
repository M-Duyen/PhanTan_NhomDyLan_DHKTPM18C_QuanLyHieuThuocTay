...
public class AddVendor extends javax.swing.JPanel implements ActionListener {

    public AddVendor() {
        initComponents();
        vendor_dao = new Vendor_DAO();
...
//        testData(tableVendor);
        ...
        ArrayList<Vendor> list = vendor_dao.getVendorList();
        loadTable(list);
    }
...
//    }
    ...
    private void txtVendorNameActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(obj.equals(btnAdd)){
            if(checkData()){
                ...
                Vendor vd = new Vendor(vendorid,vendorName,country);
                if(vendor_dao.addVendor(vd)){
                    Object[] row = {
                            vendorid,
                            vendorName,
                            country };
